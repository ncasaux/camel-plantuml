...
public class DefaultExampleWithConnectRoutesTest extends CamelTestSupport {
    ...
    public void testMock() throws Exception {
        ...
        mock.expectedBodiesReceived("@startuml\n" +
                ...
                "\n" +
                "route_e75ae82e12c615feefaf77105cf18e63 --> route_2ad9f14c90052cf9002f79d5f9fa54cb : to / from\n" +
                "\n" +
                "route_a4212b7daeffab7a6859963fce8df0c1 --> route_2ad9f14c90052cf9002f79d5f9fa54cb : to / from\n" +
                "\n" +
                ...
                "\n" +
                "route_2ad9f14c90052cf9002f79d5f9fa54cb --> route_2c3a25b7f186d9a06118c863dc529551 : enrich / from\n" +
                "\n" +
                "@enduml\n");
        ...
        template.sendBodyAndHeader("direct:camel-plantuml-http-trigger", null, "connectRoutes",true);
